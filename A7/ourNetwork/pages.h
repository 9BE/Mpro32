...
const char logPage[] PROGMEM = R"=====(
	...
	<form action="/datalog" method="POST">
    	<button type="submit">Download</button>
    </form>
	<br/>
	<form action="/clear" method="POST">
    	<button type="submit">Clear Datalog</button>
    </form>
